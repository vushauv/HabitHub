...
it("on leave with confirmation removes session from list", async () => {
  render(App());
...
it("on leave with reject doesn't remove session from list", async () => {
  render(App());
...
it("on leave with error doesn't remove session from list", async () => {
  render(App());
  const confirm = vi.fn(() => true);
  vi.stubGlobal('confirm', confirm);
