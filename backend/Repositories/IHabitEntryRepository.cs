...
public interface IHabitEntryRepository
{
    ...
    public Task<HabitEntry?> GetHabitEntryByHabitMemberDateAsync(Guid habitId, Guid memberId, DateTime date);
    public Task<bool> HasHabitEntryForDateAsync(Guid habitId, Guid memberId, DateTime date);
    ...
    public Task<List<HabitEntry>> GetHabitEntriesByHabitAndDateRangeAsync(Guid habitId, DateTime from, DateTime to);
    ...
    public Task<bool> DeleteHabitEntryByHabitMemberDateAsync(Guid habitId, Guid memberId, DateTime date);
}